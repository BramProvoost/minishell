...
/*   Updated: 2022/11/23 15:45:19 by bprovoos      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
// 		type = e_var;
// 	if (next_char == '$')
// 		add_at_end_of_list(line_lst, type, get_expantion("$$"));
// 	if (next_char == '?')
// 		add_at_end_of_list(line_lst, type, get_expantion("$?"));
// 	return (2);
// }
...
// 	var = get_expantion(var);
// 	add_at_end_of_list(line_lst, e_var, var);
// 	return (i);
// }
